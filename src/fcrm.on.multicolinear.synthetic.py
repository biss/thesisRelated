...
__date__ = '04th May 2016'

''' DESCRIPTION: normal FCRM on multicolinear synthetic data
    DATA FILE used: out_m.txt
...
if __name__ == '__main__':
    ...
    print sr.training_iter, sr.rms, sr.err