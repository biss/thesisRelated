...
class SwitchingRegression_g:
    def __init__(self, cluster=2):
        ...
        data = np.genfromtxt('input/out_n.csv', dtype=float, delimiter=',')
        ...
        self.betas[0, :] = np.array([[1.23363321, 0.217787218, -.155494883, 0.00216433672]])
        self.betas[1, :] = np.array([[0.492177465, 0.109295522, -0.000196673342, 0.0436283250]])
...
if __name__ == '__main__':
    ...
    with open('output/fcrm.garrotte.synthetic.normalized.single_c.csv', 'wb') as file:
