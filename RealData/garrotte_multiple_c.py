...
if __name__ == '__main__':
    ...
    with open('output/fcrm.garrotte.usedcars.multilpe_c.csv', 'wb') as file:
    ...
    #print c
    '''
    with open('result_output/multiple_wt_garrotte_fcrm(1.0).csv', 'wb') as file:
        writer = csv.writer(file, delimiter='\t')
